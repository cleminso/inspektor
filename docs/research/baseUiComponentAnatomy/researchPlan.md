...
4. **Inspektor wrapper application:** compare the Base UI boundary with representative wrappers in `@inspektor/ds` and identify what must be preserved, constrained, added, or kept private.

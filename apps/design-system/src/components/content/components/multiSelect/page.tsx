  ...
  return (
    <MultiSelectPlayground>
      ...
      <Section
        ...
        description="Arrow keys move between rows and their contextual actions. Enter or Space toggles a focused checkbox, while Escape closes the popup and restores trigger focus."
      />

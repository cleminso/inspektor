export const comboboxRootPropNames = [
  'items',
  'value',
  'defaultValue',
  'onValueChange',
...
export const comboboxContentPropNames = ['width', 'keepMounted', 'side', 'align'] as const
...
export const comboboxPositionerPropNames = ['side', 'align'] as const

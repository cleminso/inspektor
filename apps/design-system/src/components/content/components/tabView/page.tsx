...
export function TabViewPage(): ReactElement {
  return (
    <TabViewPlayground>
      <Section
        title="Behavior"
        description="Views select on pointer interaction or arrow-key focus. The close action appears for the active, hovered, or focused view. Press Delete while a tab is focused to close it."
      />

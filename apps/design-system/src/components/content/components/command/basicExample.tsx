  ...
  return (
    <>
      ...
      <Command.Dialog open={open} onOpenChange={setOpen}>
        ...
        <Command.Root items={actions} itemToStringLabel={(item) => item.label}>
          ...
          <Command.List>
            ...
            {actions.map((action) => (
              <Command.Item key={action.label} value={action} onClick={() => setOpen(false)}>
                <Command.ItemText label={action.label} description={action.description} />
              </Command.Item>
            ))}
          </Command.List>
          <Command.Footer>
            ...
            <span><Command.Key>Esc</Command.Key> Cancel</span>
          </Command.Footer>
        </Command.Root>
        <Command.Close />
      </Command.Dialog>

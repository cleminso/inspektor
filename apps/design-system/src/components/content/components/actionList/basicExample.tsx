...
function TableIcon(): ReactElement {
  return <svg aria-hidden="true" viewBox="0 0 14 14" width="14" height="14"><path d="M2 2h10v10H2zM2 5.5h10M5.5 2v10" fill="none" stroke="currentColor" /></svg>
}

function MoreIcon(): ReactElement {
  return <svg aria-hidden="true" viewBox="0 0 16 16" width="16" height="16"><circle cx="8" cy="3" r="1" fill="currentColor" /><circle cx="8" cy="8" r="1" fill="currentColor" /><circle cx="8" cy="13" r="1" fill="currentColor" /></svg>
}
...
export default function BasicExample(): ReactElement {
  ...
  return (
    ...
    >
      <ActionList.Item active checked={checkedNames.has('accounts')}>

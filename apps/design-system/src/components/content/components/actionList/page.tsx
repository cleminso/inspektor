...
const selectionControlProps = getGeneratedProps('actionList.selectionControl', actionListSelectionControlPropNames)
...
export function ActionListPage(): ReactElement {
  return (
    ...
    >
      ...
      <Section title="Action props"><PropsTable rows={actionProps} /></Section>
    </ComponentDocsPage>
  )
}

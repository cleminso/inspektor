...
const legendProps = getGeneratedProps(`${fieldsetItem.componentId}.legend`, fieldsetLegendPropNames)
...
export function FieldsetPage(): ReactElement {
  return (
    <FieldsetPlayground>
      ...
      <Section
        title="Root props"
        description="Root groups related controls."
      >
      ...
      <Section
        title="Legend props"
        description="Legend provides the group's accessible name."
      >

export const contextMenuRootPropNames = ['defaultOpen', 'open', 'onOpenChange', 'disabled'] as const
export const contextMenuContentPropNames = ['align', 'keepMounted', 'side'] as const
...
export const contextMenuRadioItemPropNames = [
  'value',
  'disabled',
  'closeOnClick',
  'render',

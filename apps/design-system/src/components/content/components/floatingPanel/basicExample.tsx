          ...
          >
            ...
            {presentation === 'editor' ? (
              ...
              >
                <Text
                  as="label"
                  htmlFor="floating-panel-example-name"
                  variant="label"
                >
                  Task name
                </Text>
                <Input
                  id="floating-panel-example-name"
            ...
            <FloatingPanel.Summary>
              ...
              <FloatingPanel.Actions>
                <Button
                  size="s"
                  variant="ghost"
                  onClick={() => setPresentation('editor')}
                >
                  Edit
                </Button>
                <Button
                  size="s"
                  variant="ghost"
                  onClick={() => setPresentation('failure')}
                >
                  Failure
                </Button>
              </FloatingPanel.Actions>

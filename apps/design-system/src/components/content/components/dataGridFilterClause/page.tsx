...
export function DataGridFilterClausePage(): ReactElement {
  return (
    <>
      <Section title="Compound clause">
        <Example source={createSource}>
          <CreateExample />
        </Example>
      </Section>
      <Section title="Edit">
        <Example source={editSource}>
          <EditExample />
        </Example>
      </Section>
      <Section title="Invalid clause">
        <Example source={invalidSource}>
          <InvalidExample />
        </Example>
      </Section>
      <Section title="Long value">
        <Example source={longValueSource}>
          <LongValueExample />
        </Example>
      </Section>
      <Section title="Horizontal overflow">
        <Example source={overflowSource}>
          <OverflowExample />
        </Example>
      </Section>
      <Section title="Root props">
        <PropsTable rows={getGeneratedProps('dataGridFilterClause.root', rootPropNames)} />
      </Section>
      <Section title="Trigger props">
        <PropsTable rows={getGeneratedProps('dataGridFilterClause.trigger', triggerPropNames)} />
      </Section>
      <Section title="Remove props">
        <PropsTable rows={getGeneratedProps('dataGridFilterClause.remove', removePropNames)} />
      </Section>
    </>
  )
}

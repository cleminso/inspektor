...
export const playgroundIconSource = {
  ...
  plus:
    '<svg aria-hidden="true" width={16} height={16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round"><path d="M5 12h14" /><path d="M12 5v14" /></svg>',
} as const;

...
export const componentItems: NavItem[] = [
  ...
  comboboxItem,
  {
    ...
    importPath: "@inspector/ds",
    source: { label: "command.tsx", path: "packages/design-system/src/components/command/command.tsx" },
    componentId: "command",
  },
  contextMenuItem,
  contextSwitcherItem,
  ...
  dataGridItem,
  {
    ...
    importPath: "@inspector/ds",
    source: { label: "dataGridFilterClause.tsx", path: "packages/design-system/src/components/dataGridFilterClause/dataGridFilterClause.tsx" },

...
const jazzWasmVersion = 'a161d093cd2a1b1c65749997c2d5ce94fd10c813a1be5ab22982d3ff035248fa'
const jazzWasmUrl = `https://assets.inspektor.dev/jazz/2.0.0-alpha.54/${jazzWasmVersion}/jazz_wasm_bg.bin`

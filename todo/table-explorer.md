...
[Table Explorer selection and pane behavior](../lat.md/tableExplorerBehaviors.md). Product ownership and architecture remain in the
[design document](../lat.md/design-document.md).
...
- [x] Document the remaining rendered query lifecycle in [Table row query lifecycle](../lat.md/tableRowsQueryLifecycle.md).
...
- [x] Document the rendered table-row subscription lifecycle and grid-state projection in [Table row query lifecycle](../lat.md/tableRowsQueryLifecycle.md).

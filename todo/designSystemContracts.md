...
| -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| Accordion                        | Root: value and disabled. Item/Header/Trigger: open, disabled, hidden, and index. Base still emits deprecated orientation data attributes without wrapper state reads.                                                       | Panel transition status; `--accordion-panel-height`, `--accordion-panel-width`.                                                       | Open and disabled states are styled where relevant; index, hidden, and unused width are preserved and intentionally unstyled.               |
...
| Input                            | Disabled, touched, dirty, valid, invalid, filled, focused.                                                                                                                                                                   | None.                                                                                                                                 | Disabled and invalid are styled; other Field attributes are preserved.                                                                     |

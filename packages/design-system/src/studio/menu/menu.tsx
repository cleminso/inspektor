...
export interface MenuCheckboxItemProps extends Omit<
  WithoutStyles<BaseMenu.CheckboxItem.Props>,
  'nativeButton'
> {
...
export interface MenuRadioItemProps extends Omit<
  WithoutStyles<BaseMenu.RadioItem.Props>,
  'nativeButton'
> {
  /** Controls whether changing the option closes the menu. */
  closeOnClick?: boolean
...
const MenuTrigger = forwardRef<ComponentRef<typeof BaseMenu.Trigger>, MenuTriggerProps>(
  function MenuTrigger({ disabled = false, render, ...props }, ref) {
...
const MenuGroup = forwardRef<ComponentRef<typeof BaseMenu.Group>, MenuGroupProps>(
...
const MenuGroupLabel = forwardRef<ComponentRef<typeof BaseMenu.GroupLabel>, MenuGroupLabelProps>(
...
const MenuCheckboxItem = forwardRef<HTMLDivElement, MenuCheckboxItemProps>(
  function MenuCheckboxItem({ disabled = false, closeOnClick = false, ...props }, ref) {
    const stateStyles =
      createStateStyleProps<BaseMenu.CheckboxItem.State>(getMenuCheckboxItemStyles)
    return (
...
const MenuRadioItemIndicator = forwardRef<HTMLSpanElement, MenuRadioItemIndicatorProps>(
  function MenuRadioItemIndicator({ keepMounted = false, ...props }, ref) {
...
const MenuSubmenuTrigger = forwardRef<HTMLElement, MenuSubmenuTriggerProps>(
  function MenuSubmenuTrigger({ disabled = false, children, ...props }, ref) {
    const stateStyles = createStateStyleProps<BaseMenu.SubmenuTrigger.State>(
      getMenuSubmenuTriggerStyles,
    )
    return (

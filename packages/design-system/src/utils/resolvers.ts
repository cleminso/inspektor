...
function sortedDeclarationEntries(record: CSSRecord): [string, string | number][] {
  return Object.entries(record).sort(([a], [b]) => {
    ...
    const indexA = DECLARATION_ORDER.indexOf(
      normalizedA as (typeof DECLARATION_ORDER)[number],
    )
    const indexB = DECLARATION_ORDER.indexOf(
      normalizedB as (typeof DECLARATION_ORDER)[number],
    )
...
export function resolveBoxStyles(
  ...
  addTokenProp(paddingTopStyles as StyleMap, 'padding-top', props.paddingTop ?? props.pt, spacingCss)
  addTokenProp(paddingRightStyles as StyleMap, 'padding-right', props.paddingRight ?? props.pr, spacingCss)
  addTokenProp(paddingBottomStyles as StyleMap, 'padding-bottom', props.paddingBottom ?? props.pb, spacingCss)
  addTokenProp(paddingLeftStyles as StyleMap, 'padding-left', props.paddingLeft ?? props.pl, spacingCss)
  addTokenProp(paddingInlineStyles as StyleMap, 'padding-inline', props.paddingHorizontal ?? props.px, spacingCss)
  addTokenProp(paddingBlockStyles as StyleMap, 'padding-block', props.paddingVertical ?? props.py, spacingCss)
  ...
  addTokenProp(marginRightStyles as StyleMap, 'margin-right', props.marginRight ?? props.mr, marginCss)
  addTokenProp(marginBottomStyles as StyleMap, 'margin-bottom', props.marginBottom ?? props.mb, marginCss)
  addTokenProp(marginLeftStyles as StyleMap, 'margin-left', props.marginLeft ?? props.ml, marginCss)
  addTokenProp(marginInlineStyles as StyleMap, 'margin-inline', props.marginHorizontal ?? props.mx, marginCss)
  addTokenProp(marginBlockStyles as StyleMap, 'margin-block', props.marginVertical ?? props.my, marginCss)
  ...
  addTokenProp(backgroundColorStyles as StyleMap, 'background-color', props.backgroundColor, backgroundColorCss)
  ...
  addTokenProp(borderTopLeftRadiusStyles as StyleMap, 'border-top-left-radius', props.borderTopLeftRadius, radiusCss)
  ...
  addTokenProp(flexDirectionStyles as StyleMap, 'flex-direction', props.flexDirection, (value) => value)
  ...
  addTokenProp(pointerEventsStyles as StyleMap, 'pointer-events', props.pointerEvents, (value) => value)
  ...
  if (breakpointKeys.length > 0 || pseudoKeys.length > 0) {
    ...
    for (const breakpoint of breakpointKeys) {
      ...
      if (breakpoint === 0) {
        ...
        cssParts.push(
          `@media (min-width: ${breakpoint}px) { ${selector} { ${entries} } }`,
        )
      }
    }

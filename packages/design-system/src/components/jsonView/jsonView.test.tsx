...
describe('JsonView', () => {
  ...
  it('keeps user expansion when equivalent data receives a new identity', () => {
    ...
    rerender(<JsonView accessibilityLabel="Stable expansion" data={{ profile: { name: 'Ada' } }} />)
  ...
  it('preserves the active match branch when search closes without moving focus', () => {
    ...
    rerender(<JsonView accessibilityLabel="Collapsed search" data={data} defaultExpandDepth={0} />)

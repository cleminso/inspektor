      ...
      <ClauseContext.Provider value={{ describedBy: descriptionId, disabled, invalid }}>
        ...
        >
          ...
          {invalidDescription === undefined ? null : (
            <span
              id={descriptionId}
              {...stylex.props(dataGridFilterClauseStyles.invalidDescription)}
            >
              <Icon
                artwork={CircleAlert}
                size="xs"
  ...
  function DataGridFilterClauseColumnComponent(props, ref) {
    return (
      <span
        {...props}
        ref={ref}
        {...stylex.props(dataGridFilterClauseStyles.column)}
      />
    )
  },
)
  ...
  function DataGridFilterClauseOperatorComponent(props, ref) {
    return (
      <span
        {...props}
        ref={ref}
        {...stylex.props(dataGridFilterClauseStyles.operator)}
      />
    )
  },
)
  ...
  function DataGridFilterClauseValueComponent(props, ref) {
    return (
      <span
        {...props}
        ref={ref}
        {...stylex.props(dataGridFilterClauseStyles.value)}
      />
    )
  },
)

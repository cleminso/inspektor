...
export const backgroundColorStyles = stylex.create({
  'surface-background': { backgroundColor: surfaceColors.background },
  'surface-default': { backgroundColor: surfaceColors.default },
  'surface-raised': { backgroundColor: surfaceColors.raised },
  'surface-canvas': { backgroundColor: surfaceColors.canvas },
  'surface-subtle': { backgroundColor: surfaceColors.subtle },
  'surface-overlay': { backgroundColor: surfaceColors.overlay },
  'surface-backdrop': { backgroundColor: surfaceColors.backdrop },
  'surface-inverse': { backgroundColor: surfaceColors.inverse },
  'element-default': { backgroundColor: elementColors.default },
  'element-hover': { backgroundColor: elementColors.hover },
  'element-pressed': { backgroundColor: elementColors.pressed },
  'element-selected': { backgroundColor: elementColors.selected },
  'element-disabled': { backgroundColor: elementColors.disabled },
  'ghost-element-default': { backgroundColor: ghostElementColors.default },
  'ghost-element-hover': { backgroundColor: ghostElementColors.hover },
  'ghost-element-pressed': { backgroundColor: ghostElementColors.pressed },
  'ghost-element-selected': { backgroundColor: ghostElementColors.selected },
  'ghost-element-disabled': { backgroundColor: ghostElementColors.disabled },
  'accent-element-default': { backgroundColor: accentElementColors.default },
  'accent-element-hover': { backgroundColor: accentElementColors.hover },
  'accent-element-pressed': { backgroundColor: accentElementColors.pressed },
  'accent-element-disabled': { backgroundColor: accentElementColors.disabled },
  'danger-element-default': { backgroundColor: dangerElementColors.default },
...
export const colorStyles = stylex.create({
  ...
  onAccent: { color: textColors.onAccent },
  onInverse: { color: textColors.onInverse },
})

export const borderColorStyles = stylex.create({
  default: { borderColor: borderColors.default },
  subtle: { borderColor: borderColors.subtle },
  strong: { borderColor: borderColors.strong },
  focused: { borderColor: borderColors.focused },
  selected: { borderColor: borderColors.selected },
  disabled: { borderColor: borderColors.disabled },
  warning: { borderColor: borderColors.warning },
  danger: { borderColor: borderColors.danger },
  dangerSubtle: { borderColor: borderColors.dangerSubtle },
  success: { borderColor: borderColors.success },
})

...
export const selectStyles = stylex.create({
  ...
  triggerWidthCompact: {
    minWidth: spatial["select-compact-width"],
    width: spatial["select-compact-width"],
  },
  triggerWidthContent: { minWidth: 0, width: "max-content" },
  ...
  item: {
    ...
    gridTemplateColumns: `${spatial["icon-size-m"]} minmax(0, 1fr)`,
    lineHeight: lineHeights.ui,
    userSelect: "none",
  ...
  itemText: { gridColumnStart: "2", minWidth: 0 },
  indicator: {
    alignItems: "center",
    display: "inline-flex",
    gridColumnStart: "1",
